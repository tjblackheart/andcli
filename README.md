...
A usable vault implementation for andcli is basically just an interface providing one function called `Entries()`. Have a look at the [current implementations](internal/vaults) to see how this works.
